...
const interVariable = `
  @font-face {
    ...
    src: url(${interVarRomanWoff2}) format('woff2-variations'),
...
const interVariableItalic = `
  @font-face {
    ...
    src: url(${interVarItalicWoff2}) format('woff2-variations'),
...
const interVariableExperimental = `
  @font-face {
    ...
    src: url(${interVarExperimentalWoff2}) format('woff2-variations'),
